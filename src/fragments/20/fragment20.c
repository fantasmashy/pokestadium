...
static u32 D_86E049F8[] = {
    ...
    0x2303FFFF, (u32)D_86E03E48, 0x0000FFFF, 0xFFFFFFFF, 0x22010000, (u32)D_86E04870, 0x1D010102, 0x03F400E0, 0xFB500000,
    0x00000000, 0x00014000, 0x00010000, 0x00010000, 0x05000000, 0x2301FFFF, (u32)D_86E03DD8, 0x0002FFFF, 0xFFFFFFFF,
    0x22010000, (u32)D_86E047C8, 0x06000000, 0x1D000103, 0x000000FA, 0xE3D40000, 0x00000000, 0x00117869, 0x0005FADE,
    0x00010000, 0x05000000, 0x2306FFFF, (u32)D_86E03E10, 0x0001FFFF, 0xFFFFFFFF, 0x22010000, (u32)D_86E04840, 0x06000000,
    0x06000000, 0x06000000, 0x06000000, 0x04000000,
};

static u32 D_86E04AE0[] = {
    0x17000003, 0x00000094, (u32)D_86E03DB0, 0x00000000, (u32)D_86E03E88, 0x05000000, 0x1C000000, 0x00001999,
    0x00001999, 0x00001999, 0x05000000, 0x03000000, (u32)D_86E049F8, 0x06000000, 0x06000000, 0x01000000,
};
...
static u32 D_86E04B34[] = {
    ...
    0x00000000, (u32)D_86E04AE0, 0x06000000, 0x06000000, 0x05000000, 0x0A000000, (u32)&D_800AC840, 0x06000000,
    0x06000000, 0x06000000, 0x03000000, (u32)D_87806398, 0x06000000, 0x01000000,
};
...
void miniMetapodHumanControls(MiniActor* metapod) {
    ...
    switch (metapod->mainState) {
        case 1: // start harden
            ...
            func_81407D48(1.0f, metapod->totalPos, metapod->totalRot, func_879029F0, (unk_D_8140E728_01C*)&D_87903E40, 4);
            metapod->mainState++;
            break;
            ...
            if (compMetapod->unk_244 < 0) {
                if ((compMetapod->unk_2AA == 0) && (compMetapod->isSquashed == false)) {
                    if (compMetapod->unk_29E > 0) {
                        ...
                        func_81407D48(1.0f, compMetapod->totalPos, compMetapod->totalRot, func_879029F0, (unk_D_8140E728_01C*)&D_87903E40,
                                      4);
                    } else {
